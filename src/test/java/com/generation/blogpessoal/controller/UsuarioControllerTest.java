...
//indica o ciclo de vida do teste, por classe 
@TestInstance(TestInstance.Lifecycle.PER_CLASS)

//onde ficam as requisições http
public class UsuarioControllerTest {
	...
	@Test
	@DisplayName("Cadastrar Um Usuário") //mensagem exibida
	public void deveCriarUmUsuario() {
		
		//objeto da classe HttpEntity para requisição 
	...
	public void naoDeveDuplicarUsuario() {
		...
		assertEquals(HttpStatus.BAD_REQUEST, corpoResposta.getStatusCode());//método para checar se a resposta da requisição é a esperada
	}
